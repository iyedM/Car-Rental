...
export default function Footer() {
    ...
    return (
        <footer className="relative border-t border-content/10 bg-main/80 backdrop-blur-md mt-16">
            {/* Glow accent */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex items-center gap-3">
                            <a
                                ...
                                className="w-9 h-9 glass-card rounded-lg flex items-center justify-center text-content/40 hover:text-brand-400 hover:border-brand-500/30 transition-all duration-200"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-9 h-9 rounded-lg flex items-center justify-center text-[#1c1917] transition-all duration-200 hover:shadow-lg"
                    ...
                    {/* Links */}
                    <div>
                        <h3 className="font-semibold text-content mb-5 text-sm uppercase tracking-wider">Navigation</h3>
                        <ul className="space-y-3">
                            {links.map(link => (
                                <li key={link.href}>
                                    <Link
                                        to={link.href}
                                        className="text-content/50 hover:text-brand-400 text-sm transition-colors duration-200 flex items-center gap-2 group"
                                    >
                    ...
                    {/* Locations */}
                    <div>
                        <h3 className="font-semibold text-content mb-5 text-sm uppercase tracking-wider">Nos Agences</h3>
                        <ul className="space-y-3">
                            {locations.map(loc => (
                                <li key={loc} className="flex items-center gap-2 text-content/50 text-sm">
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="font-semibold text-content mb-5 text-sm uppercase tracking-wider">Contact</h3>
                        <div className="space-y-4">
                            <a href="tel:+21622307649" className="flex items-center gap-3 group">
                                ...
                                <div>
                                    <p className="text-content/30 text-xs">Téléphone</p>
